...
public class Main {
    ...
    /** Initializes .gitlet directory and stuff.
     */
    ...
    /** Adds blobs to staging area for commits to use.
     *
    ...
    /** Removes file from CWD and adds to rm staging area.
     *
    ...
    /** Does all the committing and stuff.
     *
     * @param args Array of arguments.
     */
     ...
     *
     * @param args Array of arguments I suppose.
     */
    ...
    /** The version of checkout which was easy.
     *
     * @param args Array of arguments.
     */
     ...
     *
     * @param args Array of arguments again.
     */
    ...
    /** The really scary checkout one with the branches.
     * @param args Array of arguments ot be passed in I suppose.
     */
    ...
    /** Resets something, I don't remember.
    ...
    /**Finds the commit via commit message string.
    ...
    /** I am here to please the style gods.
     *
     * @param args Array of args.
     */
    ...
    /**Does the merge specific commit work.
     *
    ...
    /** Does heavy lifitng for merge, finds most conditions.
     *
    ...
    /**removes some of the heavy lifting from mergeCombo1 for finding conflicts.
     *
     * @param currCommit Current commit.
     * @param givenCommit Given commit.
     ...
     * @param cwdVersion The files in the CWD passed in from mergecombo1.
     * @return
     */
     ...
     * because my Head implementation
     * is kinda dumb.
     *
